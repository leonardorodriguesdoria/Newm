...
function cadPessoa(Cliente , Data) {
...
function altPessoa(Cliente , Data) {

    pessoas.rows[index].cells[1].innerHTML = Cliente;
...
function preencheCamposForm() {
    ...
    for(var i = 0; i < pessoas.rows.length; i++) 
    {
        pessoas.rows[i].onclick = function() 
        {
            ...
            document.getElementById("txtCliente").value = pessoas.rows[index].cells[1].innerText;//""""
